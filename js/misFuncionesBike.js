function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://144.22.224.251:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionSkate() {
    $.ajax({
        url:"http://144.22.224.251:8080/api/Bike/all",
...
function pintarRespuestaSkate(response){
    ...
    myTable+="<tr>";
        ...
        myTable+='<td><button class = "botonSkate2" onclick="cargarDatosSkate(' + response[i].id + ')">Editar bicicleta!</button></td>';
...
function cargarDatosSkate(id) {
    $.ajax({
        dataType: 'json',
        url:"http://144.22.224.251:8080/api/Bike/"+id,
   ...
   // if($("#name").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description").val().length == 0){
    ...
    //}else{
            ...
            $.ajax({
                ...
                url:"http://144.22.224.251:8080/api/Bike/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://144.22.224.251:8080/api/Bike/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"144.22.224.251:8080/api/Bike/update",
